;;; material-light-theme.el --- Theme 

;; Copyright (C) 2016 , nicholas-miklaucic
...
;;; Commentary: This theme uses Material Design colors for a nice color scheme. It recycles the same
;;; uses as its dark pair, but changes the values.
